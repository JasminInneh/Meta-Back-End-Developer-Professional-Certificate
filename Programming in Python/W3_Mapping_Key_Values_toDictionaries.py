...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   generate_usernames_list = [name.replace(" ","_") for name in mod_list]
   return generate_usernames_list
   print(generate_usernames_list)
   raise NotImplementedError()
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   map_id_to_initial_dict = {emp["name"][0]:emp["id"] for emp in employee_list}
   return map_id_to_initial_dict
   print(map_id_to_initial_dict)
   raise NotImplementedError()
